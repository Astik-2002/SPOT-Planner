...
class safeRegionRrtStarDynamic
{
	private:
		...
		Eigen::Vector3d start_pt, inform_centroid, pcd_origin;
		Eigen::Vector4d end_pt, commit_root;
  ...
  public:
		...
		void setStartPt( Eigen::Vector3d startPt, Eigen::Vector3d endPt, double averageVel);
		...
		inline Eigen::Vector4d getRootCoords();
		...
		inline int  checkNodeRelation( double dis, NodePtr_dynamic node_1, NodePtr_dynamic node_2 );
